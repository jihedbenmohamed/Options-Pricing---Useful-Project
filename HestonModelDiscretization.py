...
def CIR_Sample(NoOfPaths,kappa,gamma,vbar,s,t,v_s):
    ...
    # NoOfPaths fil fct hathy najam ni7a fi souret ma kappaBar is a vector, "ou fil cas hathy KappaBar vecteur la5ater v_s vecteur"
    # mli5er fct traja3 vecteur kan na3tiha parametre ithani vecteur ou kan parametre thani nombre reel wa7ed lalzem n7ot parametre thalith 
    # ya3tini y7adidli taille mta3 l vecteur 
    return  sample
